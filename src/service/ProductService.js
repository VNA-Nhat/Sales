    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (filter) {
                ...
                //limit(limt): giới hạn tìm kiếm để trả result 
...
module.exports = { createProduct, updateProduct, getDetailsProduct, deleteProduct, getAllProduct, deleteManyProduct, getAllType }